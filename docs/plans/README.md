...
| 1 | [phase-1-intelligence-alerting.md](phase-1-intelligence-alerting.md) | Weeks 7–14: tiered alerting, delivery channels, NLP upgrades, active learning | 🟡 Milestone 1 built (alerts engine + composer + Telegram) |
