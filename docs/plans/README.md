...
| 1 | [phase-1-intelligence-alerting.md](phase-1-intelligence-alerting.md) | Weeks 7–14: tiered alerting, delivery channels, NLP upgrades, active learning | 🟡 Milestones 1–3 built (alerts engine + composer + Telegram; delivery worker + web push + SMS stub; Whisper voice notes) |
