...
| 3 | [phase-3-depth.md](phase-3-depth.md) | Months 7–10: inundation + digital twin, SITREPs, rumor tracker, post-disaster mode, mobile app, IoT — and the microservice split | 🟡 Milestone 1 built (bathtub inundation model over a real Copernicus DEM extract, wired into alerts + routing) |
